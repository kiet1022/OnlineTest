...
<div class="container">
    ...
    <form action="" method="post">
        ...
        @foreach($testDetail as $t)
            ...
            <input type="radio" value="A"> {{$t->question->a}}
            <br /><br>
            <input type="radio" name="ans[${list.readnumber}]" value="B"> {{$t->question->b}}
            <br /><br>
            <input type="radio" name="ans[${list.readnumber}]" value="C"> {{$t->question->c}}
            <br /><br>
            <input type="radio" name="ans[${list.readnumber}]" value="D"> {{$t->question->d}}
            <br /><br>
            @endforeach
