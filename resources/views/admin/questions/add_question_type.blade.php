...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item " aria-current="page">Thêm chủ đề câu hỏi</li>
</ol>
</nav>
<div class="col-sm-8 offset-sm-2">
    ...
    @endif
    <form action="{{route('post_add_new_question_type')}}" method="post">
        @csrf
        <div class="form-group">
            <label for="ipnewstype">Tên loại câu hỏi</label>
            <input type="text" class="form-control" id="idquestiontype" placeholder="Nhập tên chủ đề câu hỏi" name='typename'>
        </div>
